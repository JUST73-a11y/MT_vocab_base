...
async function cleanup() {
    ...
    try {
        ...
        // Safely determine test users
        // Condition:
        // - Email is 'teacher@gmail.com' OR 'student@gmail.com'
        // - Role is 'admin' AND email is NOT the exact admin email in the allowlist
        // - Email contains 'test' (e.g. test@...)
        const filter = {
            $or: [
                ...
                { email: '123456789' } // Just in case a bad email got in
            ]
        };
        ...
        // 1. Fetch matching users to find their IDs
        ...
        // 2. Delete related records for these accounts
        ...
        // Final verification of remaining admins
